...
//
//        TextView quantity_friends = findViewById(R.id.count_friend);
...
//                startActivityWithAnimation(this, ReactActivity.class,userId, R.anim.slide_up);
//            });
//
...
//    }
//
//    private void startActivityWithAnimation(Context context, Class<?> cls, String userId, int animEnter) {
